...
class FinanceiroDashboard extends TPage
{
    ...
    function __construct()
    {
        ...
        try
        {
            ...
            $div->add( TElement::tag('div', TPanelGroup::pack('A pagar por mês', $table1), ['class' => 'col-sm-6']) );
            ...
            $div->add( TElement::tag('div', TPanelGroup::pack('Saldos em aberto por fornecedor', $table2), ['class' => 'col-sm-6']) );
