...
class FaturaDashboard extends TPage
{
    ...
    function __construct()
    {
        ...
        try
        {
            ...
            $indicator1->enableSection('main', ['title' => 'Depesas no mês', 'icon' => 'calendar-check', 'background' => 'green', 'value' => 'R$ '.number_format($vendas_mes,2,',','.') ] );
            
            $indicator2 = new THtmlRenderer('app/resources/info-box.html');
            $indicator2->enableSection('main', ['title' => 'Depesas no ano', 'icon' => 'calendar-check', 'background' => 'blue', 'value' => 'R$ '.number_format($vendas_ano,2,',','.') ] );
            ...
            $grafico1->enableSection('main', ['data'   => json_encode($data), 'width'  => '100%', 'height'  => '350px',
                                              'title'  => 'Total por mês', 'ytitle' => 'Pago', 'xtitle' => 'Mês', 'uniqid' => uniqid()]);
            ...
            $grafico2->enableSection('main', ['data'   => json_encode($data), 'width'  => '100%', 'height'  => '350px',
                                              'title'  => 'Total por ano', 'ytitle' => 'Pago', 'xtitle' => 'Ano', 'uniqid' => uniqid()]);
