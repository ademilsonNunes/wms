 ...
 */
class PalletList extends TPage
{
   ...
   //     $this->setDefaultOrder('id', 'asc');         // defines the default order
        ...
        */
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_search_pallet');
        $this->form->setFormTitle('Controle de Movimentação de Pallets');
      ...
      //  $ativo->setLayout('horizontal');
        ...
        $this->form->addFields( [ new TLabel('Transportador') ], [ $nome ] );
      ...
      //  $this->form->addFields( [ new TLabel('Ativo') ], [ $ativo ] );
       ...
       // $this->form->setData( TSession::getValue(__CLASS__.'_filter_data') );
        ...
        $this->form->addActionLink(_t('New'), new TAction(['PalletForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green');
        ...
        $column_nome = new TDataGridColumn('nome', 'Transp', 'left');
       // $column_tipo_servico_id = new TDataGridColumn('tipo_servico->nome', 'Tipo Serviço', 'left');
        $column_qtdeEnt   = new TDataGridColumn('qtdeEnt',  'Qtde. Entrada',  'right');
        $column_qtdeSai   = new TDataGridColumn('qtdeSai',  'Qtde. Saída',    'right');
        $column_qtdeQueb  = new TDataGridColumn('qtdeQueb', 'Qtde. Quebrado', 'left');
        $column_qtdeSaldo = new TDataGridColumn('qtdeSaldo','Qtde. Saldo',    'left');
        ...
        */
        ...
        $this->datagrid->addColumn($column_qtdeEnt);
        $this->datagrid->addColumn($column_qtdeSai);
        $this->datagrid->addColumn($column_qtdeQueb);
        $this->datagrid->addColumn($column_qtdeSaldo);
